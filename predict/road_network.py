...
class roadmap:
    ...
    def trend_infer(self, rs, date, time_period, rate):
        seed = self.seeds
        p_max = 0
        delta_v_max = -1
        delta_v_dict = dict()
        ...
        while True:
            ...
            for edge in rs.W:
                ...
                if id in edge:
                    ...
                    print(other_road, temp1, rs.W[edge])
